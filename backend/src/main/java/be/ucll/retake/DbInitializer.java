...
public class DbInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if (gameRepository.count() == 0) {gameRepository.save(new Game(570, "Dota 2"));
            ...
            gameRepository.save(new Game(228280, "Baldur's Gate"));
        }
        ...
        if (reportRepository.count() == 0) {
            ...
            Game bg1 = gameRepository.findBySteamAppid(228280).orElseThrow();
            ...
            reportRepository.save(new Report(enis, gtav, Tier.Silver, "Fedora",
                "Playable but needs tweaks — occasional crashes in online mode.", "Proton 8.0-5"));
            reportRepository.save(new Report(annie, gtav, Tier.Gold, "Ubuntu",
                "Story mode runs perfectly. Online is hit or miss.", "Proton 9.0-3"));
            reportRepository.save(new Report(sundae, gtaiv, Tier.Bronze, "Arch",
                "Runs, but frequent frame drops and audio crackle. Needs work.", "Proton 8.0-5"));
            reportRepository.save(new Report(enis, gtaiii, Tier.Gold, "Ubuntu",
                "Old game, runs great with a community patch.", "Proton 7.0-6"));


            reportRepository.save(new Report(sundae, hades, Tier.Platinum, "Arch",
                "Perfect, runs better than on Windows honestly.", "Proton 9.0-3"));
            reportRepository.save(new Report(annie, hades, Tier.Platinum, "Ubuntu",
                "Zero issues, native-feeling performance.", "Proton 9.0-3"));
            reportRepository.save(new Report(annie, hades2, Tier.Gold, "SteamOS",
                "Early access but very smooth on the Deck.", "Proton Experimental"));


            reportRepository.save(new Report(sundae, hollowknight, Tier.Platinum, "Ubuntu",
                "Runs flawlessly, one of the best Linux experiences.", "Proton 9.0-3"));


            reportRepository.save(new Report(annie, stardew, Tier.Gold, "Ubuntu",
                "Very pleasant experience.\n\nI launched the game with Proton because it was the easiest way I found to install the Stardew Valley Very Expanded (SVVE) mod. Everything works perfectly, including multiplayer!",
                "Custom Proton: GE-Proton10-34"));
            reportRepository.save(new Report(sundae, stardew, Tier.Platinum, "SteamOS",
                "Perfect on the Steam Deck, no setup needed.", "Proton 9.0-3"));


            reportRepository.save(new Report(enis, bg3, Tier.Gold, "Ubuntu",
                "Runs beautifully after the latest Proton update. Long load times on older drives.", "Proton 9.0-3"));
            reportRepository.save(new Report(annie, bg3, Tier.Platinum, "SteamOS",
                "Steam Deck verified for a reason — flawless.", "Proton Experimental"));
            reportRepository.save(new Report(sundae, bg1, Tier.Platinum, "Arch",
                "Classic runs perfectly through the Enhanced Edition.", "Proton 8.0-5"));
        }
    }
}
